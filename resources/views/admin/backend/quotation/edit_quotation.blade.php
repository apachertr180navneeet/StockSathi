        ...
        <div class="d-flex flex-column-fluid">
            <div class="container-fluid my-4">
                <div class="d-md-flex align-items-center justify-content-between">
                    <h3 class="mb-0">Edit quotations</h3>
                    <div class="text-end my-2 mt-md-0"><a class="btn btn-outline-primary"
                            href="{{ route('all.quotation') }}">Back</a></div>
                </div>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <table class="table table-striped table-bordered dataTable"
                                                    ...
                                                    <tbody id="productBody">
                                                        @foreach ($editData->quotationItems as $item)
                                                            <tr data-id={{ $item->id }}>
                                                ...
                                                <div class="form-group w-100">
                                                    ...
                                                    <select name="status" id="status"
                                                        ...
                                                        <option value="Accepted"
                                                            {{ $editData->status == 'Accepted' ? 'selected' : '' }}>Accepted
                                                        </option>
                                                        <option value="Rejected"
                                                            {{ $editData->status == 'Rejected' ? 'selected' : '' }}>Rejected
                                                        </option>
                                                    </select>
                                                    @error('status')
                                                        <span class="text-danger">{{ $message }}</span>
