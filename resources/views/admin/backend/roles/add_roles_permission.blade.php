...
<div class="content mt-3 px-3">
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h4 class="fs-20 fw-semibold m-0">Add Role in Permission</h4>
        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-9">
                                    ...
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" name="permission[]" type="checkbox" value="{{ $permission->id }}" id="checkDefault{{ $permission->id }}">
