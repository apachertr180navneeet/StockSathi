            ...
            <div class="container-fluid my-4">
                <div class="d-md-flex align-items-center justify-content-between">
                    ...
                    <div class="text-end my-2 mt-md-0"><a class="btn btn-outline-primary"
                            href="{{ route('all.sale.return') }}">Back</a></div>
                </div>


                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('update.sale.return', $editData->id) }}" method="post"
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="py-3" id="fullPaid">
                                                                            <input type="text" class="form-control"
                                                                                name="full_paid" id="fullPaidInput"
                                                                                value="{{ $editData->full_paid }}">
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
