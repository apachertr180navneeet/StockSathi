            ...
            <div class="container-fluid my-4">
                <div class="d-md-flex align-items-center justify-content-between">
                    ...
                    <div class="text-end my-2 mt-md-0"><a class="btn btn-outline-primary"
                            href="{{ route('all.transfer') }}">Back</a></div>
                </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <div class="form-group w-100">
                                                    <label class="form-label" for="formBasic">From Warehouse : <span
                                                            class="text-danger">*</span></label>
                                                    <select name="from_warehouse_id" id="warehouse_id"
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <div class="form-group w-100">
                                                    <label class="form-label" for="formBasic">To Warehouse : <span
                                                            class="text-danger">*</span></label>
                                                    <select name="to_warehouse_id" id="warehouse_id"
                                                        class="form-control form-select">
                                                        <option value="">Select Warehouse</option>
                                                        @foreach ($warehouses as $item)
                                                            <option value="{{ $item->id }}">{{ $item->name }}</option>
