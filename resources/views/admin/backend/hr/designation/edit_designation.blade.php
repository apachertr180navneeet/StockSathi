    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title mb-4">Edit Designation</h4>

                        <form action="{{ route('update.designation') }}" method="POST" id="myForm">
                            @csrf
                                ...
                                <div class="col-sm-10">
                                    <select name="department_id" id="department_id" class="form-select" required>
                                        @foreach($departments as $dept)
                                            <option value="{{ $dept->id }}" {{ $dept->id == $designation->department_id ? 'selected' : '' }}>{{ $dept->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input name="name" class="form-control" type="text" id="name" value="{{ $designation->name }}" required>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="description" id="description" class="form-control" rows="3">{{ $designation->description }}</textarea>
                                </div>
                            </div>
