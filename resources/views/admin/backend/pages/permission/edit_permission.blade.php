                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="group_name" class="form-select" id="example-select">
                                        ...
                                        <option value="WareHouse"
                                            {{ $permissions->group_name == 'WareHouse' ? 'selected' : '' }}>WareHouse
                                        </option>
                                        <option value="Supplier"
                                            {{ $permissions->group_name == 'Supplier' ? 'selected' : '' }}>Supplier</option>
                                        <option value="Customer"
                                            {{ $permissions->group_name == 'Customer' ? 'selected' : '' }}>Customer</option>
                                        <option value="Product"
                                            {{ $permissions->group_name == 'Product' ? 'selected' : '' }}>Product</option>
                                        <option value="Purchase"
                                            {{ $permissions->group_name == 'Purchase' ? 'selected' : '' }}>Purchase</option>
                                        <option value="Sale" {{ $permissions->group_name == 'Sale' ? 'selected' : '' }}>
                                            Sale</option>
                                        <option value="Due" {{ $permissions->group_name == 'Due' ? 'selected' : '' }}>
                                            Due</option>
                                        <option value="Transfers"
                                            {{ $permissions->group_name == 'Transfers' ? 'selected' : '' }}>Transfers
                                        </option>
                                        <option value="Report"
