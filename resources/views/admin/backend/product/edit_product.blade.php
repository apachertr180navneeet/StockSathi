...
<div class="content mt-3 px-3">
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h4 class="fs-20 fw-semibold m-0">Edit Product</h4>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select name="barcode_symbology" class="form-control form-select">
                                                <option value="C128" {{ old('barcode_symbology', $editData->barcode_symbology) == 'C128' ? 'selected' : '' }}>Code 128</option>
                                                <option value="C39" {{ old('barcode_symbology', $editData->barcode_symbology) == 'C39' ? 'selected' : '' }}>Code 39</option>
                                                <option value="EAN13" {{ old('barcode_symbology', $editData->barcode_symbology) == 'EAN13' ? 'selected' : '' }}>EAN-13</option>
                                                <option value="UPCA" {{ old('barcode_symbology', $editData->barcode_symbology) == 'UPCA' ? 'selected' : '' }}>UPC-A</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" name="batch_no"
                                                value="{{ old('batch_no', $editData->batch_no) }}"
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="date" name="expiry_date"
                                                value="{{ old('expiry_date', $editData->expiry_date) }}"
                                                class="form-control">
                                        </div>
