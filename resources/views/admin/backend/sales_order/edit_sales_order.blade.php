            ...
            <div class="container-fluid my-4">
                <div class="d-md-flex align-items-center justify-content-between">
                    ...
                    <div class="text-end my-2 mt-md-0"><a class="btn btn-outline-primary"
                            href="{{ route('all.sales.order') }}">Back</a></div>
                </div>


                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('update.sales.order', $editData->id) }}" method="post"
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <table class="table table-striped table-bordered dataTable"
                                                    ...
                                                    <tbody id="productBody">
                                                        @foreach ($editData->salesOrderItems as $item)
                                                            <tr data-id={{ $item->id }}>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group w-100">
                                                    ...
                                                    <select name="status" id="status"
                                                        ...
                                                        <option value="Sent"
                                                            {{ $editData->status == 'Sent' ? 'selected' : '' }}>Sent
                                                        </option>
                                                        <option value="Pending"
                                                            {{ $editData->status == 'Pending' ? 'selected' : '' }}>Pending
                                                        </option>
                                                        <option value="Confirmed"
                                                            {{ $editData->status == 'Confirmed' ? 'selected' : '' }}>Confirmed
                                                        </option>
                                                        <option value="Cancelled"
                                                            {{ $editData->status == 'Cancelled' ? 'selected' : '' }}>Cancelled
                                                        </option>
                                                    </select>
                                                    @error('status')
                                                        <span class="text-danger">{{ $message }}</span>
                            ...
                            <div class="col-xl-12">
                                <div class="d-flex mt-5 justify-content-end">
                                    ...
                                    <a class="btn btn-secondary" href="{{ route('all.sales.order') }}">Cancel</a>
                                </div>
                            </div>
                    </div>
                    </form>
